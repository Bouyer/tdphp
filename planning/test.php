        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
           ...
           if(Auth::islog()){ 
            	...
            	echo ' 		<li><a href="logout.php">DM-CM-)connexion</a></li>';
                echo ' 	</ul>';
              	echo ' </li>';
            	echo '</ul>';
             	echo '<p class="navbar-text pull-right">ConnectM-CM-) en tant que</p>';
...
<div class="span12">
  <?php
   ...
   echo "<form class=\"form-inline\" action=\"ajoutbase.php\" method=\"POST\">";
